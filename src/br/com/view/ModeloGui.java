 ...
 */
public class ModeloGui extends javax.swing.JFrame {

    private ModeloTableModel model;

    public ModeloGui() {
        initComponents();
        List<Modelo> lista = new ArrayList<Modelo>();
        ModeloController a = new ModeloController();
        lista = a.listarModelo();

        //cria o modelo de Produto      
        model = new ModeloTableModel(lista);
    ...
    private void btInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btInserirActionPerformed
        InserirModeloGui im = new InserirModeloGui(model);
        im.setVisible(true);
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        if (selecionado >= 0) {
            ...
            AtualizarModeloGui am = new AtualizarModeloGui(selecionado, cdModelo, model);
            am.setVisible(true);
        } else {
    ...
    private void efetuaPesquisa() {
        ...
        List<Modelo> lista = new ArrayList<Modelo>();
        ModeloController a = new ModeloController();
        lista = a.listarModeloByNome(nome);
        model.limpar();
